...
public class deliveredorderdata extends RecyclerView.Adapter<deliveredorderdata.myHolder> implements Filterable {
    Context mcontext;
    public deliveredorderdata(Context context, ArrayList<setdata> data) {
        this.data = data;
        mcontext=context;
    }
    ...
    public myHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.delivery, parent, false);
...
//        Glide.with(holder.postimg2.getContext()).load(data.get(position).getRandomkey()).into(holder.postimg2);
        ...
        holder.users.setText(petDataa.getUser());
        ...
        holder.cancelorder.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DatabaseReference strec = (DatabaseReference) FirebaseDatabase.getInstance().getReference("record").child("payment").child(petDataa.getCategory());
                setdata pd = new setdata(petDataa.getAmount());
                strec.push().setValue(pd);

                DatabaseReference cateData = (DatabaseReference) FirebaseDatabase.getInstance().getReference("student").child("order").child(petDataa.getCategory());
                Query dummyQuery = cateData
                        .orderByChild("ran")
                        .equalTo(petDataa.getRan());
    ...
    public class myHolder extends RecyclerView.ViewHolder {
        TextView price1, cancelorder, title1, users, quan;
